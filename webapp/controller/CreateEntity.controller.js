sap.ui.define([
	...
	return BaseController.extend("personNS.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Persons", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Persons", oData);
