sap.ui.define([
	...
	return BaseObject.extend("personNS.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias personNS.model.ListSelector
		 */
		 ...
		 * @return {personNS.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
