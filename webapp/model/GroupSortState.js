sap.ui.define([
	...
	return BaseObject.extend("personNS.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias personNS.model.GroupSortState
		 */
		...
		/**
		 * Groups by Age, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function(sKey) {
			...
			if (sKey === "Age") {
				...
				this._oViewModel.setProperty("/sortBy", "Age");

				aSorters.push(
					new Sorter("Age", false,
